...
public class Graphics {
    ...
    public static void DrawTriangle(Triangle triangle, Color color){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            Vec2 normalizeCoordinates = Utils.ScreenSpaceToNormalizedCoordinates(triangle.get(i).position);
            Vec2 normalizeCoordinatesNext = Utils.ScreenSpaceToNormalizedCoordinates(triangle.get((i + 1) % 3).position);
    ...
    public static void FillTriangle(Triangle triangle, Color color){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            float depth = Utils.ProjectOntoToFace(
                triangle.get(0), triangle.get(1), triangle.get(2), new Vec3(triangle.get(0).position.x, triangle.get(0).position.y, 0)).z;
